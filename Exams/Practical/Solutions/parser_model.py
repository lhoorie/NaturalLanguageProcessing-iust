...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.hidden_to_hidden_weight = nn.Parameter(torch.Tensor(self.hidden_size, self.hidden_size))
    ...
    def forward(self, w):
        ...
        h1 = F.relu(x @ self.embed_to_hidden_weight + self.embed_to_hidden_bias)
        h2 = F.relu(h1 @ self.hidden_to_hidden_weight + self.hidden_to_hidden_bias)
        o = self.dropout(h2)
        logits = o @ self.hidden_to_logits_weight + self.hidden_to_logits_bias
        return logits
